-- 29_lap_bo_combo_eco.sql
-- Mở lap_bo_combo cho bản ECO (WH15AECO/WH30AECO). ECO: làm mềm + 2× UPF10 (thiết bị,
-- không có chính sách BH nên activate_warranty trả hạn null — không lỗi) · PP/PAC là
-- lõi, không tạo dòng (đã lọc ở linhKienCombo). Chỉ đổi danh sách combo hợp lệ.
